...
nobtn.addEventListener("click" , () => {
   ...
   if (nobtnclicked >= 10){
      ...
      setTimeout((screamer) => {
         img.src = "https://media2.giphy.com/media/v1.Y2lkPTc5MGI3NjExNXRnMTI1aTM4aXFxeTRyZGQwcGpyczF1bDdwaDl4M3p0MGlnYTBrZCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/8hGGAmA60LsaTYdarh/giphy.gif"
      }, 3000) 
...
function changes() {
   ...
   setTimeout((create) => { 
      ...
      newbtn.addEventListener("click", () => {
         ...
         var newboxtxt = document.createElement("a");
         newbox.appendChild(newboxtxt);
         newboxtxt.textContent = "Un petit cadeau pour toi";
         newboxtxt.href = "https://linktw.in/xwnqLl";
         newbox.classList.add("container-video");
         newboxtxt.classList.add("video-link")
